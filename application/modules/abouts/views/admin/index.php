...
<table class="list">
    ...
    <tr <?php echo cycle()?>>
        ...
        <td>
            <a class="btn" href="abouts/admin/abouts/form/<?php echo $row->id ?>" >แก้ไข</a>
            <a class="btn" href="abouts/admin/abouts/delete/<?php echo $row->id?>" onclick="return confirm('<?php echo lang('notice_confirm_delete');?>')">ลบ</a>
        </td>
        </tr>
    <?php endforeach; ?>
