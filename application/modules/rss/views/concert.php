...
<rss version="2.0"
  ...
  ?>    
        <item>
          ...
          <link><?php echo site_url('concerts/watch/'.$post->slug) ?></link>
          <guid><?php echo site_url('/concerts/watch/'.$post->slug) ?></guid>
          <description>
          		<?php echo xml_convert('<img src="http://img.youtube.com/vi/'.getYouTubeIdFromURL($post->vdo_script).'/0.jpg">'); ?>
