<style type="text/css">
.aviaslider{ 
height:330px; 	/*this changes the height of the image slider*/
width:692px;
overflow: hidden;
position: relative;
...
<ul class='aviaslider' id="frontpage-slider">
	<?php foreach($hilights as $hilight):?>
		<li><a href="<?php echo $hilight->url?>" title=""><img src="uploads/hilight/<?php echo $hilight->image?>" alt="<?php echo lang_decode($hilight->title)?>"  width="732" height="330" /></a></li>
	<?php endforeach;?>
</ul>