...
$(document).ready(function(){
	...
	// $(".inputTextArea").live('keyup', function(e) {
        // var el = $(this);
        // setTimeout(function() {
            // var text = $(el).val();
        	// $.post('vdos/admin/vdos/getThumb',{
        		// 'iframe':text
        	// },function(data){
        		// el.closest("tr").prev().find(".thumb").html(data);
        	// });
        // }, 100);
	// });
...
<div style="width:305px; position: fixed; top: 192px; right: 30px;">
	<textarea name="geturlPaser" style="width:300px; height:100px;"></textarea><br>
